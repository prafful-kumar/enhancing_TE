...
if __name__ == "__main__":
    ...
    parser.add_argument('--output-dir', type=str, default='./results_metrics_group1',
                        help='dir of output score')
    parser.add_argument('--alpha', type=float, default=0.005)
    parser.add_argument('--sigma', type=float, default=0.6)
    parser.add_argument('--type', type=str, default=None) # which metric to test after applying spread-attract method
    ...
    if (args.type in['NCTI']) or (args.metric in ['ncti']):
        all_score = []
        cls_score = []
        cls_compact = []
